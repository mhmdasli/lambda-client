    ...
    public static mails = [
        {
            ...
            'subject': 'הפגישה שלנו ביום רביעי',
            'message': '<p>     שלום רב, אני רוצה לתזכר אותך לגבי הפגישה שלנו ביום ראשון,נפגשים בבית קפה גריג ברחוב בני ציון 15 נצרת עילית </p>',
            'time': '28 Jun',
            'read': false,
            'starred': false,
            'important': true,
        ...
        },
        {
            ...
            'subject': 'סיכום פגישה',
            'message': '<p>   הי ליאת,שמחתי להכיר אותך היום, הייתה לנו פגישה מעולה ,צרפתי במייל סיכום לפגישה שלנו מוזמן לראות ולתת חוות דעת, יום וה שיהיה לך </p>',
            'time': '28 Jun',
            'read': false,
            'starred': false,
            'important': false,
        ...
        },
        {
            ...
            'subject': 'ביטול פגישה',
            'message': '<p> היי חיים,רציתי לעדכן אותך על ביטול הפגישה שהיתה אמורה להתקיים ביום חמישי בשעה 14:30 בגלל סיבות בריאותיות, עמכם הסליחה, הודעה במועד החדש תשלח בהמשל</p>',
            'time': '28 Jun',
            'read': true,
            'starred': false,
            'important': false,
        ...
        },
        {
            ...
            'subject': 'עדכון שעה פגישה',
            'message': '<p>צהוריים טובים תומר,ברכות האתר שלך יעלה לאוויר היום בשעה 6:00 בערב, תתכונינו בהתאם ושיהיה המון מזל טוב" בהצלחה. רנין מוסא </p>',
            'time': '28 Jun',
            'read': true,
            'starred': true,
            'important': false,
        ...
        },
        {
            ...
            'subject': 'טבלת סידור משלוחי ימי ראשון ושני',
            'message': '<p>היי עאמר, מצ"ב טבלה לסידור המשלוחים לימי ראשון ושני לשבוע הבא </p>',
            'time': '26 Jun',
            'read': true,
            'starred': false,
            'important': false,
        ...
        },
        {
            ...
            'subject': 'עיצוב מחדש',
            'message': '<p>היי עדנה,מצב"ב הפרסומת שצריכה עיצוב מחדש, הצבעים לא תואמים ופונט דיי גדול,הוראות מדוייקות מצורפות לקובץ</p>',
            'time': '18 Jun',
            'read': true,
            'starred': false,
            'important': true,
