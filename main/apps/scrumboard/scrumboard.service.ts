...
export class ScrumboardService implements Resolve<any>
{
    ...
    {
        return new Promise((resolve, reject) => {
            this._httpClient.get(environment.apiUrl + 'scrumboard/scrumboard-boards')
    ...
    {
        return new Promise((resolve, reject) => {
            this._httpClient.get(environment.apiUrl + 'scrumboard/scrumboard-board/' + boardId)
                .subscribe((response: any) => {
                    this.board = response;
    ...
    {
        return new Promise((resolve, reject) => {
            this._httpClient.post(environment.apiUrl + 'scrumboard/scrumboard-board/' + this.board.id, this.board)
                .subscribe(response => {
                    this.onBoardChanged.next(this.board);
                    resolve(this.board);
                }, reject);
    ...
    {
        return new Promise((resolve, reject) => {
            this._httpClient.post(environment.apiUrl + 'scrumboard/scrumboard-board', board)
                .subscribe(response => {
                    resolve(response);
                }, reject);
        });
